...
contract GlobalSharingEconomyCoin is Pausable, ERC20 {
  ...
  /**
   * åªå…è®¸é¡¹ç›®æ–¹ç©ºæŠ•ï¼Œå¦‚æžœé¡¹ç›®æ–¹ç¦æ­¢æ‰¹é‡è½¬å¸ï¼Œä¹ŸåŒæ—¶ç¦ç”¨ç©ºæŠ•
   */
  function airdrop(address[] _funds, uint256 _amount) public whenNotPaused whenPrivateFundEnabled returns (bool) {
    ...
    // æ ¹æ®gaslimitçš„é™åˆ¶ï¼Œè¶…è¿‡300ä¸ªåœ°å€çš„å¾ªçŽ¯åŸºæœ¬å°±æ— æ³•æˆåŠŸæ‰§è¡Œäº†
    ...
    // å¦‚æžœæ‰§è¡Œå¤±è´¥ï¼Œåˆ™ä¼šå›žæ»šæ•´ä¸ªäº¤æ˜“
  ...
  /**
   * å…è®¸äº¤æ˜“æ‰€å’Œé¡¹ç›®æ”¾æ–¹æ‰¹é‡è½¬å¸
   * _funds: æ‰¹é‡è½¬å¸åœ°å€
   * _amounts: æ¯ä¸ªåœ°å€çš„è½¬å¸æ•°é‡ï¼Œé•¿åº¦å¿…é¡»è·Ÿ_fundsçš„é•¿åº¦ç›¸åŒ
   */
